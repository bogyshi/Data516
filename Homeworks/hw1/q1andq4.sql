...
--Query completed in 0.564 + 0.650+0.521+0.511
-- 10000 rows
/*
1
...
-- Query completed in 0.453 +0.366+0.555+0.474
-- num rows: 1
...
-- Query completed in 0.759 +0.442+0.529+0.552
-- 10000 rows returned
/*
1
...
-- Query completed in 0.604 +0.410+0.454+0.406
-- 25 rows
/* first 2
1
PERU
...
-- Query completed in 0.491+0.452+0.507+0.481
...
/*
alternative form of this query, but lacks all suppliers
...
--Query completed in 0.413+0.509+0.393+0.475, min 0.393, avg 0.4475, max 0.509
-- returned 2 rows
/*
gold
...
-- Query completed in 2.441 +2.41+1.725+2.60, min 1.725, avg 2.294, max 2.60
-- num rows returned 2
/*
1
